  ...
  module Validation
    class AllVariableUsesDefined < Rule
      def initialize
        ...
        # @operation_variables_used = {} of Graphene::Language::Nodes::OperationDefinition => Array(String)
        @operation_variables_used = Hash(Graphene::Language::Nodes::OperationDefinition, Array(String)).new do |hash, key|
          hash[key] = [] of String
        end
        ...
        @operation_fragments_referenced = Hash(Graphene::Language::Nodes::OperationDefinition, Array(String)).new do |hash, key|
          hash[key] = [] of String
        end
      ...
      def leave(node : Graphene::Language::Nodes::FragmentDefinition, context)
        @scope = nil
      end
