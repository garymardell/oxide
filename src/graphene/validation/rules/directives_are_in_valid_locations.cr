module Graphene
  module Validation
    class DirectivesAreInValidLocations < Rule
      def initialize
        @adjacent_stack = [] of Tuple(Graphene::Language::Nodes::Node, Directive::Location)
      end
      ...
      record_adjacent Graphene::Language::Nodes::FragmentSpread, Directive::Location::FRAGMENT_SPREAD
      record_adjacent Graphene::Language::Nodes::InlineFragment, Directive::Location::INLINE_FRAGMENT
      record_adjacent Graphene::Language::Nodes::Field, Directive::Location::FIELD
      record_adjacent Graphene::Language::Nodes::FragmentDefinition, Directive::Location::FRAGMENT_DEFINITION
