class QueryResolver < Graphql::Schema::Resolver
  def resolve(object, field_name, argument_values)
    ...
    when "charge"
      ...
      Charge.new(id: argument_values["id"].to_s.to_i32, status: "pending", reference: "ch_1234", receipt_id: 1)
    when "charges"
      [
        Charge.new(id: 1, status: "paid", reference: "ch_1234", receipt_id: 1),
        Charge.new(id: 2, status: "pending", reference: "ch_5678", receipt_id: 2),
        Charge.new(id: 3, status: nil, reference: "ch_5678", receipt_id: 3)
      ]
    when "transactions"
      [
        Charge.new(id: 1, status: "paid", reference: "ch_1234", receipt_id: 1),
