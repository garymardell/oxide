...
class QueryResolver < Graphql::Schema::Resolver
  def resolve(object, field_name, argument_values)
    ...
    when "charges"
      [
        Charge.new(id: 1, status: "paid", reference: "ch_1234", refund_id: 1234),
        Charge.new(id: 2, status: "pending", reference: "ch_5678", refund_id: 4567),
        Charge.new(id: 3, status: nil, reference: "ch_5678", refund_id: 8910)
      ]
    when "transactions"
      [
